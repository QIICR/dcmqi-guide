...
* [3D Slicer](http://slicer.org) - provides interactive application to load and process DICOM data; includes `dcmqi` as an extension; uses `dcmqi` to perform conversion of the objects it supports.