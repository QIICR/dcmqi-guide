...
1. [**Use one of the DICOM defined coding schemes**](user_guide/existing_coding_scheme.md): this option often requires more effort, but it will make your resulting data harmonized with the existing controlled terminologies, facilitating reasoning on the resulting data an aggregation of the results collected from different sources. The choice of the coding scheme and specific codes will depend on the specific data conversion task.
